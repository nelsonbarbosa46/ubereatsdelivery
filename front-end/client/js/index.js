function continueScript() {
    $(document).ready(function () {
        ...
        $('input#formChangeInfoNIF').characterCounter();
        ...
        $("#formChangeInfoLocation").on("keyup", function () {
            ...
            if (text) {
                ...
                console.log(jQuery.inArray(textLowerCase, arrCountiesLowerCase) + " :1");
        ...
        //check if its a driver on form change info
        $("#formChangeInfoIsDriver").click(function () {
            if ($("#formChangeInfoIsDriver").is(":checked")) {
                $("#formDriver").fadeIn();
            } else {
                $("#formDriver").fadeOut();
            }
